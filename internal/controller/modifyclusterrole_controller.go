...
// +kubebuilder:rbac:groups=rbac.kim.karolinska.se,resources=modifyclusterroles,verbs=get;list;watch;create;update;patch;delete
...
// the ModifyClusterRole object against the actual cluster state, and then
